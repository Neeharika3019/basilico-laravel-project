...
<main>
    ...
    <input type="text" id="search" placeholder="Search Menu Item" class="search-box">
    <button type="button" id="clearSearch" class="clear-btn">Clear</button>
    <button type="button" id="loadJsonBtn" class="clear-btn">Load JSON Menu</button>
    </div>
...
$(document).ready(function(){
    ...
    $('#search').keyup(function(){
        ...
        $('.menu-table tbody tr').filter(function(){
